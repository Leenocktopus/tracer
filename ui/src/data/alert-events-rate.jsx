...
import {getAlertEventsRate, getTracesRate} from "../util/api-calls";

const AlertEventsRate = ({range, type}) => {
    ...
    const fetchTracesRate = async () => {
        setLoading(true)
        const response = await getAlertEventsRate({
...
export default AlertEventsRate
